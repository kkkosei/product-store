...
const ProfilePage = () => {
  ...
  const handleDelete = (id) => {
    if (confirm("Delete this project?")) deleteProject.mutate(id);
  };
      ...
      {projects?.length === 0 ? (
        <div className="card bg-base-300">
          <div className="card-body items-center text-center py-16">
            ...
            <p className="text-base-content/40 text-sm">Start by creating your first project</p>
        ...
        <div className="grid gap-4">
          {projects.map((project) => (
            <div key={project.id} className="card card-side bg-base-300">
              ...
              <div className="card-body p-4">
                ...
                <p className="text-sm text-base-content/60 line-clamp-1">{project.description}</p>
